...
from agents import startup_agent
from agents import execute_mongo_query
    ...
    try:
      if is_stream:
        ...
        async def event_generator():
            ...
            try:
                # Stream events directly from the LangGraph agent execution graph
