import chromadb
from config import COLLECTION1, COLLECTION2, COLLECTION3, COLLECTION4, DB_NAME1
from context import CONTEXT, SCHEMA2, SCHEMA3, SCHEMA4
...
def initialize_chromadb():
    ...
    if collection_name not in existing_collections:
        ...
        collection.upsert(
            documents=[
                "Contains RV Capital firm's Profit and Losses for various valuation dates - fundwise/assets/themes/traders/tradenames."
                f"{CONTEXT}",
                
                f"Contains Balance sheet Charges and Expenses done by Trader on that ValuationDate. {SCHEMA2}",
                # "Contains Authorised Limit's that a Trader can spend", 
            ...
            metadatas=[
                ...
                # {"db_type": "MongoDB", "target": COLLECTION3, "schema": SCHEMA3},
                # {"db_type": "MongoDB", "target": COLLECTION4, "schema": SCHEMA4},
            ],
